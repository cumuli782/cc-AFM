This example demonstrates the calculation of a series of cc-AFM images of the 2-Iodotriphenylene on Ag(111) from the full electronic density. The calculations include the effects of the probe-particle deflection and the probe-tip interaction. Starting point are the charge density of the sample (*CHG_sample*), the charge density of the probe-particle (*CHG_tip*) and the electrostatic potential (*LOCPOT*) as they are calculated by VASP (all can be found in the *example* folder). The resulting images should be show some similarity to figure ... in ... (they will differ quite significantly, since the resolution of all files has been reduced for the upload. This effects each step of the calculation and the errors add up)
